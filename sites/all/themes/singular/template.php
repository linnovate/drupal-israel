...
function singular_langbar($lang){
  $lang_arr = array('he' =>t('Hebrew') ,'en' => 'English' , 'fr'=>'French');
  foreach ($lang_arr as $langcode => $langurl) {
    if ($lang == $langcode){continue;}
    print l($lang_arr[$langcode], $GLOBALS['base_url'] . '/' . $langcode);
  }
